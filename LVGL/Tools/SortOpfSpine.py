...
def itemref_insert_all():
    ...
    itemref_insert('details/widgets/ime_pinyin.xhtml')
    ...
    itemref_insert('details/main-modules/indev/gridnav.xhtml')

    itemref_insert('details/main-modules/fonts/index.xhtml')
    itemref_insert('details/main-modules/fonts/overview.xhtml')
    itemref_insert('details/main-modules/fonts/built_in_fonts.xhtml')
    itemref_insert('details/main-modules/fonts/binfont_loader.xhtml')
    itemref_insert('details/main-modules/fonts/imgfont.xhtml')
    itemref_insert('details/main-modules/fonts/bdf_fonts.xhtml')
    itemref_insert('details/main-modules/fonts/rtl.xhtml')
    itemref_insert('details/main-modules/fonts/new_font_engine.xhtml')
    itemref_insert('details/main-modules/fonts/font_manager.xhtml')
    ...
    itemref_insert('details/main-modules/observer/index.xhtml')
    itemref_insert('details/main-modules/observer/observer.xhtml')
    itemref_insert('details/main-modules/observer/observer_examples.xhtml')
    ...
    itemref_insert('details/main-modules/draw/snapshot.xhtml')
    ...
    itemref_insert('details/libs/font_support/index.xhtml')
    itemref_insert('details/libs/font_support/freetype.xhtml')
    itemref_insert('details/libs/font_support/tiny_ttf.xhtml')

    itemref_insert('details/libs/fs_support/index.xhtml')
    itemref_insert('details/libs/fs_support/fs.xhtml')
    itemref_insert('details/libs/fs_support/arduino_esp_littlefs.xhtml')
    itemref_insert('details/libs/fs_support/arduino_sd.xhtml')
    itemref_insert('details/libs/fs_support/frogfs.xhtml')
    itemref_insert('details/libs/fs_support/lfs.xhtml')

    itemref_insert('details/libs/image_support/index.xhtml')
    itemref_insert('details/libs/image_support/bmp.xhtml')
    itemref_insert('details/libs/image_support/gif.xhtml')
    itemref_insert('details/libs/image_support/libjpeg_turbo.xhtml')
    itemref_insert('details/libs/image_support/libpng.xhtml')
    itemref_insert('details/libs/image_support/lodepng.xhtml')
    itemref_insert('details/libs/image_support/libwebp.xhtml')
    itemref_insert('details/libs/image_support/rle.xhtml')
    itemref_insert('details/libs/image_support/rlottie.xhtml')
    itemref_insert('details/libs/image_support/svg.xhtml')
    itemref_insert('details/libs/image_support/tjpgd.xhtml')
    
    itemref_insert('details/libs/video_support/index.xhtml')
    itemref_insert('details/libs/video_support/ffmpeg.xhtml')
    itemref_insert('details/libs/video_support/gstreamer.xhtml')
    ...
    itemref_insert('details/debugging/monkey.xhtml')
    itemref_insert('details/debugging/obj_id.xhtml')
    itemref_insert('details/debugging/monkey.xhtml')
    itemref_insert('details/debugging/profiler.xhtml')
    itemref_insert('details/debugging/sysmon.xhtml')
    itemref_insert('details/debugging/test.xhtml')
