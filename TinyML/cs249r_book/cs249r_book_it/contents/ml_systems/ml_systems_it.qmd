...
Man mano che questo capitolo procede, esploreremo il mondo complesso e affascinante dei sistemi embedded. Acquisiremo informazioni sulla loro progettazione strutturale e sulle caratteristiche operative e comprenderemo il loro ruolo chiave nel potenziare le applicazioni ML. A partire dalle basi delle unità microcontrollore, esamineremo le interfacce e le periferiche che ne migliorano le funzionalità. Questo capitolo è progettato per essere una guida completa che chiarisce gli aspetti sfumati dei sistemi embedded all'interno del framework dei sistemi ML.

::: {.callout-tip}

## Obiettivi dell'Apprendimento

* Acquisire una conoscenza completa dei sistemi ML, incluse le loro definizioni, architettura e linguaggi di programmazione.

* Esplorare i principi di progettazione e operativi dei sistemi ML, incluso l'uso di un microprocessore, la gestione della memoria, l'integrazione System-on-chip (SoC) e lo sviluppo e l'implementazione di modelli di machine learning [apprendimento automatico].

* Esaminare le interfacce, la gestione dell'alimentazione e le caratteristiche operative in tempo reale essenziali per sistemi ML efficienti insieme a considerazioni su efficienza energetica, affidabilità e sicurezza.

* Esaminare le distinzioni, i vantaggi, le problematiche e i casi d'uso per Cloud ML, Edge ML e TinyML, sottolineando la selezione dell'approccio di apprendimento automatico appropriato in base alle esigenze specifiche dell'applicazione e al panorama in evoluzione dei sistemi embedded nel machine learning.

:::

## Introduzione

Il ML si sta evolvendo rapidamente, con nuovi paradigmi che plasmano il modo in cui i modelli vengono sviluppati, addestrati e implementati. Uno di questi paradigmi è l'apprendimento automatico embedded, che sta vivendo un'innovazione significativa guidata dalla proliferazione di sensori intelligenti, dispositivi edge e microcontrollori. Il machine learning embedded si riferisce all'integrazione di algoritmi di apprendimento automatico nell'hardware di un dispositivo, consentendo l'elaborazione e l'analisi dei dati in tempo reale senza fare affidamento sulla connettività cloud. Questo capitolo esplora il panorama dell'apprendimento automatico embedded, coprendo gli approcci chiave di Cloud ML, Edge ML e TinyML (@fig-cloud-edge-tinyml-comparison).
...
Fino a questo punto, abbiamo esplorato singolarmente ciascuna delle diverse varianti di ML. Ora, mettiamole insieme per una visione completa. @tbl-big_vs_tiny offre un'analisi comparativa di Cloud ML, Edge ML e TinyML basata su varie caratteristiche e aspetti. Questo confronto mira a fornire una chiara prospettiva sui vantaggi unici e sui fattori distintivi, aiutando a prendere decisioni informate in base alle esigenze e ai vincoli specifici di una determinata applicazione o progetto.

+------------------------------+--------------------------------------------------------------+-----------------------------------------------------------------------+------------------------------------------------------------------+
| Aspetto                      | Cloud ML                                                     | Edge ML                                                               | TinyML                                                           |
+:=============================+:=============================================================+:======================================================================+:=================================================================+
| Ubicazione dell'elaborazione | Server centralizzati (Data Center)                           | Dispositivi locali (più vicini alle fonti di dati)                    | Sul dispositivo (microcontrollori, sistemi embedded)             | 
+------------------------------+--------------------------------------------------------------+-----------------------------------------------------------------------+------------------------------------------------------------------+
