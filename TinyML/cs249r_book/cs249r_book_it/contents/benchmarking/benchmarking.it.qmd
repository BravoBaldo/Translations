...
* Scoprire i principali benchmark, metriche e tendenze del modello, tra cui accuratezza, correttezza, complessità ed efficienza.
...
## Introduzione {#sec-benchmarking-ai}
...
Eseguendo il benchmarking per questi tipi di metriche, possiamo ottenere una visione completa delle prestazioni e dell'efficienza del processo di formazione da una prospettiva di sistema. Ciò può aiutare a identificare le aree di miglioramento e garantire che le risorse siano utilizzate in modo efficace.
...
![Il dataset Coco. Fonte: Coco.](images/png/coco.png)<https://cocodataset.org/images/jpg/coco-examples.jpg>{#fig-coco}
...
@fig-flops, da [@bianco2018benchmark], mostra la relazione tra la Top-1 Accuracy su ImageNet (asse y), i G-FLOP del modello (asse x) e il conteggio dei parametri del modello (dimensione del cerchio).
