...
# Collaboratori {.unnumbered}

Esprimiamo i nostri più sinceri ringraziamenti al gruppo eterogeneo di persone che hanno generosamente contribuito con la loro competenza, intuizioni e tempo a migliorare sia il contenuto che il codice di questo progetto. Di seguito c'è l'elenco di tutti i collaboratori. Per contribuire a questo progetto, consultare la nostra pagina [GitHub](https://github.com/harvard-edge/cs249r_book).
