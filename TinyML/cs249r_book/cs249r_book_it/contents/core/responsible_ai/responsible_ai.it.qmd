...
Sebbene innovazione e regolamentazione siano spesso viste come interessi contrapposti, molti paesi hanno ritenuto necessario fornire supervisione man mano che i sistemi di intelligenza artificiale si espandono in più settori. Come mostrato in @fig-human-centered-ai, questa supervisione è diventata cruciale poiché questi sistemi continuano a permeare vari settori e ad avere un impatto sulla vita delle persone (vedere [AI incentrata sull'uomo, Capitolo 8 "Interventi e normative governative"](https://academic-oup-com.ezp-prod1.hul.harvard.edu/book/41126/chapter/350465542).
