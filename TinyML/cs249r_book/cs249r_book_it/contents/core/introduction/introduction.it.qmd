...
Ha definito questo concetto "ubiquitous computing", promettendo un mondo in cui la tecnologia ci avrebbe servito senza richiedere la nostra costante attenzione o interazione. Facciamo un salto in avanti fino a oggi, e ci troviamo sul punto di realizzare la visione di Weiser, grazie all'avvento e alla proliferazione dei sistemi di machine learning [apprendimento automatico].
...
Questa visione sta già iniziando a prendere forma, come illustrato dalle comuni applicazioni dell'IA che ci circondano nella nostra vita quotidiana (@fig-applications-of-ml). Dall'assistenza sanitaria e dalla finanza ai trasporti e all'intrattenimento, l'apprendimento automatico sta trasformando vari settori, rendendo le nostre interazioni con la tecnologia più intuitive e personalizzate.
