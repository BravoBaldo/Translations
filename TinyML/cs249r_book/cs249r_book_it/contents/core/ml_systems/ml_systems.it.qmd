...
Risorse: [Slide](#sec-ml-systems-resource), [Video](#sec-ml-systems-resource), [Esercizi](#sec-ml-systems-resource)
:::
...
Cloud ML sfrutta potenti server nel cloud per il training e l'esecuzione di modelli ML complessi e di grandi dimensioni e si basa sulla connettività Internet. @fig-cloud-ml fornisce una panoramica delle capacità di Cloud ML che discuteremo più in dettaglio in questa sezione.

![Panoramica della sezione per Cloud ML.](images/png/cloudml.png){#fig-cloud-ml}
