...
I principi chiave di DevOps includono collaborazione, automazione, integrazione continua, distribuzione e feedback. DevOps si concentra sull'automazione dell'intera pipeline di distribuzione del software, dallo sviluppo alla distribuzione. Mira a migliorare la collaborazione tra i team di sviluppo e operativi, utilizzando strumenti come [Jenkins](https://www.jenkins.io/), [Docker](https://www.docker.com/) e [Kubernetes](https://kubernetes.io/) per semplificare il ciclo di vita dello sviluppo.
...
In genere, i team valutano i modelli rispetto ai [dataset di test](https://en.wikipedia.org/wiki/Training,_validation,_and_test_sets) di holdout che non vengono utilizzati durante la formazione. I dati di test provengono dalla stessa distribuzione dei dati di produzione. I team calcolano metriche come [accuratezza](https://en.wikipedia.org/wiki/Accuracy_and_precision), [AUC](https://en.wikipedia.org/wiki/Receiver_operating_characteristic#Area_under_the_curve), [precisione](https://en.wikipedia.org/wiki/Precision_and_recall), [richiamo](https://en.wikipedia.org/wiki/Precision_and_recall) e [punteggio F1](https://en.wikipedia.org/wiki/F1_score).
...
I team MLOps sfruttano ampiamente gli strumenti "[infrastructure as code (IaC)](https://www.infoworld.com/article/3271126/what-is-iac-infrastructure-as-code-explained.html)" e le solide architetture cloud per gestire attivamente le risorse necessarie per lo sviluppo, la formazione e la distribuzione dei sistemi ML.
...
+-------------------------+---------------------------------------------------+------------------------------------------------------+
| Considerazioni sui dati | Creazione di set di dati di formazione            | Privacy, etica, informazioni sanitarie protette      |
+-------------------------+---------------------------------------------------+------------------------------------------------------+
