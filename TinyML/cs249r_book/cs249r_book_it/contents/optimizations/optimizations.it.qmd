...
# Ottimizzazioni del Modello {#sec-model_optimizations}
...
* [posit](https://ieeexplore.ieee.org/document/9399648) - Un formato configurabile che può rappresentare diversi livelli di precisione in base ai bit esponente. Mira a essere più efficiente dei float binari IEEE 754. Ha una gamma dinamica e una precisione regolabili.
